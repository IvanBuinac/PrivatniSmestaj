...
require_once APPPATH.'third_party/Facebook/FacebookRequestException.php';
require_once APPPATH.'third_party/Facebook/FacebookOtherException.php';
    ...
    **/
    public function user()
    {
        ...
        if ($session)
        {
            ...
            {
                // Get user details
                $user = (new FacebookRequest($session, 'GET', '/me?fields=email,first_name,last_name,hometown,location'))
                    ->execute()
                    ->getGraphObject()
                    ->asArray();
