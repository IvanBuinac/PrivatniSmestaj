 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'ivan.buinac.182.11-facilitator_api1.ict.edu.rs' : 'ivan.buinac.182.11_api1.ict.edu.rs';
$config['APIPassword'] = $config['Sandbox'] ? 'L2U8B47H7TPK88FW' : 'B4B98A7YV5ES4UJK';
$config['APISignature'] = $config['Sandbox'] ? 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-A8Y4SYECGvsXKS4klzQPEXeLxwgk' : 'AFcWxV21C7fd0v3bYYYRCpSSRl31A9FGf3z6HDnHmVBKgt6Q7zxDNOMz';
